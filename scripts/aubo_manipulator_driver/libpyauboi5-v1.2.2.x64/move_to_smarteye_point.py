...
def main():
    ...
    # IP='192.168.1.12'
    # StartPoint=[4.57,36.47,130.57,73.98,81.65,4.85]
#     bTc=[0.08121, -0.05556, 0.99515, 0.23136950,
# -0.99660, 0.00970, 0.08187, -0.04833978, 
# -0.01420, -0.99841, -0.05459, 0.90349450,0,0,0,1 ]
    # bTc=[0.46321,-0.06409,0.88393,0.2437,-0.88599,-0.00907,0.46362,-0.085,-0.0217,-0.9979,-0.06098,0.829,0,0,0,1]
    # maxacctuple=(0.5, 0.5, 0.5, 0.5, 0.5, 0.5)
    # maxvelctuple=(0.5, 0.5, 0.5, 0.5, 0.5, 0.5)
    Point_data_1=[0.15765,-0.05829,0.9410576]#[-0.239463,-0.0300859,0.983125]#[0.131,-0.242,0.903]#[0.119,-0.116,1.003]
    ratet=1
